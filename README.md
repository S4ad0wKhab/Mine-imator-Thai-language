...
# 🚫ข้อจำกัดความรับผิด
โปรเจกต์นี้ถูกสร้างโดยผู้ใช้ทั่วไป ทางเราไม่ได้เกี่ยวข้องกับ ทีมงาน Mine-imator
This project was created by a general user; we are not affiliated with the Mine-imator team.
# ❓️ก่อนจะมีโปรเจกต์นี้
...
# ✅️ปัญหาที่รับทราบแล้ว
ไม่มี
# ✅️ช่องทางติดตามอัพเดท
...
* **ฟอนต์สำหรับแสดงผลตัวอักษรภาษาไทย**
* Noto Sans Thai โดย Google และ คัดสรร ดีมาก (Cadson Demak)
* Itim โดย คัดสรร ดีมาก (Cadson Demak)
* Sarabun (TH Sarabun PSK/New) โดย ศุภกิจ เฉลิมลาภ
